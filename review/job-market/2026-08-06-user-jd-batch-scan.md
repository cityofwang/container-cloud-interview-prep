...
> **来源：** 学员提供 **6 张招聘截图**（Boss/猎聘类 App，2026-08-06）。  
> **口令等价：** `补岗位 JD` / 学员发 JD 截图或文字。  
...
| 项 | 说明 |
|----|------|
| 获取方式 | **非**助手主动爬取；学员截图 → 助手 OCR/解读 → 落库 |
| 为何上次对话「没找到」 | 内容在**对话附件**里，未写入仓库前新 Chat **不可见**；现已落 `review/job-market/` |
| 局限 | 无公司全名/薪资的帖已按岗位类型归档；银行/ToB 软技能不自动加权 |
| 后续 | 学员继续发 JD → 追加本文件 §7 或新建 `YYYY-MM-DD-user-jd-*.md` |
...
| 日期 | 变更 |
|------|------|
| 2026-08-06 | 初版：学员 6 截图批次；并入 skills-inventory §7 |
