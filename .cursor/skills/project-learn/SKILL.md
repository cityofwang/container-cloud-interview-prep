...
description: >-
  ...
  项目规划-only, 项目加章, or wants to learn a tracked open-source project
...
2. 若学员指定章节 → 读该章；否则按 INDEX **下一未会章**
3. **2～4 句**：项目状态、建议本章、等价口令
4. **先答后讲**：自测/探测题 → 再讲解（同 interview-coach 铁律）
5. **默认不打乱 FZ**：若学员未说插队，场末提醒「面试主线仍当前 FZ」
